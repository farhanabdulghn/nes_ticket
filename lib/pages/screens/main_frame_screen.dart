...
import 'package:nes_ticket/pages/screens/home_screen.dart';
import 'package:nes_ticket/pages/screens/profile_screen.dart';
import 'package:nes_ticket/pages/screens/watchlist_screen.dart';
...
class _MainFrameScreenState extends State<MainFrameScreen> {
  ...
  static const _pages = [HomeScreen(), WatchlistScreen(), ProfileScreen()];
